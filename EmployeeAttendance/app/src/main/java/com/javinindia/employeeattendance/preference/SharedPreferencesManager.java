package com.javinindia.employeeattendance.preference;
...
public class SharedPreferencesManager {
    ...
    public static String getAadhar(Context context) {
        return getSharedPreferences(context).getString("Aadhar", null);
    }

    public static void setAadhar(Context context, String aadhar) {
        final SharedPreferences.Editor editor = getSharedPreferences(context).edit();
    ...
    public static void setEmpId(Context context, String aadhar) {
        final SharedPreferences.Editor editor = getSharedPreferences(context).edit();
        editor.putString("EmpId", aadhar);
        editor.commit();
    }
    ...
    public static void setType(Context context, String aadhar) {
        final SharedPreferences.Editor editor = getSharedPreferences(context).edit();
        editor.putString("Type", aadhar);
        editor.commit();
    }
